...
- **图标和品牌资源更新**：更新 favicon 和 logo 图片资源，提升品牌视觉一致性。
- **Bug**：修复在 chrome 下截图，多出来的 scrollbar 问题。

## [v0.3] - 2025-01-27

### ✨ 新特性

- **图片转换功能**：支持 Mermaid 和 PlantUML 图表自动转换为图片，提升文档兼容性。
- **GitHub 图床优化**：更友好的 GitHub 图床设置界面，简化配置流程。
- **自动转图重置**：页面刷新时自动运行转图重置，确保图片转换状态同步。
- **图标和作者信息更新**：替换为新的图标和作者信息，提升品牌一致性。

### 🛠 功能优化与问题修复

- **转图功能修复**：修复转图重置功能，确保图片转换流程稳定可靠。
- **Mermaid 转图支持**：新增对 Mermaid 图表的转图支持，扩展图表类型覆盖。
- **PlantUML 转图支持**：新增对 PlantUML 图表的转图支持，满足更多技术文档需求。

### 👏 贡献者

感谢所有贡献者的努力！🚀  
**MarkTwain** 将持续为打造更流畅、更强大的 Markdown 创作体验不断前行！
